...
extern unsigned char UPLOAD_BUFF[3280];//转义完成后的数组，上传的网关的数组
extern unsigned char PROTOCOL_SEND_BUFF[3280];//将数据摆在这个数组中，然后做转义
...
extern unsigned char UPLOAD_BUFF[3280];
